...
import { residentData } from '../data/mockData'; // Importa os dados
  ...
  return (
    <div className="px-4 py-2 space-y-6">
      ...
      <div>
        ...
        <p className="text-md text-gray-400">{residentData.level}</p>
      </div>
       {/* O resto do componente permanece igual, já usando os dados importados */}
